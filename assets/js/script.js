const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./img/logoBlanco.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                ...
                <p class="h4" style="text-align: center;">Agotaste tus intentos</p>`,
        ...
        indicarVictoria() {
            Swal.fire({
                ...
                <p class="h4" style="text-align: center;>Muy bien hecho</p>`,
                    confirmButtonText: "Jugar de nuevo",
                    confirmButtonColor: "#611232",
                    allowOutsideClick: false,
                    allowEscapeKey: false,
        ...
        // Mostrar alerta de tip financiero
        mostrarTip(imagen) {
            Swal.fire({
                    title: imagen.titulo,
                    ...
                    imageWidth: 150,
                    imageHeight: 150,
                    imageAlt: "Tip financiero",
                    // html: `<img class="img-fluid" src="${imagen.ruta}" alt="Tip financiero">`,
        ...
        precargarImagenes() {
            ...
            imagenesPrecarga.forEach(imagenPrecarga => {
                const imagen = document.createElement("img");
                imagen.src = imagenPrecarga.ruta;
